...
public class DriverFormDTO
{
    ...
    [StringLength(30, MinimumLength = 3, ErrorMessage = "VehicleNo must be between 3 and 30 Characters.")]
    public string VehicleNo{get;set;}
    
    [Required(ErrorMessage = "Model is required.")]
    [StringLength(30, MinimumLength = 3, ErrorMessage = "Model must be between 3 and 30 Characters.")]
    public string Model { get; set; }
    
    [Required(ErrorMessage = "VehicleType is required.")]
    [StringLength(30, MinimumLength = 3, ErrorMessage = "VehicleType must be between 3 and 30 Characters.")]
