...
namespace KiloTaxi.EntityFramework.Migrations
{
    ...
    public partial class _1_Added_Tables_Init_1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverImageLicenseFront = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: true
                    ),
                    DriverImageLicenseBack = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: true
                    ),
                    EmailVerifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessLicenseImage = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: true
                    ),
                    VehicleLicenseFront = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: true
                    ),
                    VehicleLicenseBack = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: true
                    ),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionScreenShoot = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: false
                    ),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "PromotionUsage");

            migrationBuilder.DropTable(name: "Review");

            migrationBuilder.DropTable(name: "TopUpTransaction");

            migrationBuilder.DropTable(name: "Vehicle");

            migrationBuilder.DropTable(name: "ScheduleBooking");

            migrationBuilder.DropTable(name: "Promotion");

            migrationBuilder.DropTable(name: "WalletTransaction");

            migrationBuilder.DropTable(name: "Driver");

            migrationBuilder.DropTable(name: "Customer");

            migrationBuilder.DropTable(name: "WalletUserMapping");
