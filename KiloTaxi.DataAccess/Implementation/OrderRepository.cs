...
namespace KiloTaxi.DataAccess.Implementation
{
    public class OrderRepository : IOrderRepository
    {
        ...
        public OrderPagingDTO GetAllOrders(PageSortParam pageSortParam)
        {
            try
            {
                var query = _dbKiloTaxiContext
                    .Orders.Include(r => r.Customer)
                    .Include(r => r.Driver)
                    .AsQueryable();
                ...
                var orders = query.Select(OrderConverter.ConvertEntityToModel).ToList();
        ...
        public OrderDTO GetOrderById(int id)
        {
            try
            {
                ...
                return OrderConverter.ConvertEntityToModel(orderEntity);
            }
            catch (Exception ex)
            {
                LoggerHelper.Instance.LogError(
